...
<body>
	...
	<div class="container pt-3">
		...
		<form name="form1" method="post" action="/user/mypage/member/memMyUpdateForm.do">
			<h2>마이페이지</h2>
			<ul class="list-group">
			  ...
			  <li class="list-group-item">이미지: <img src="/resources/images/upload/member/${sessionScope.user.storedfilename}" class="img-fluid" width="30%" height="30%" /></li>
